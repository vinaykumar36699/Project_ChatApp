...
public class Chat_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        messages_adapter = findViewById(R.id.messageAdater);

        messagesArrayList = new ArrayList<>();
        adapter = new Messages_Adapter(Chat_Activity.this, messagesArrayList);
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(this);
        linearLayoutManager.setStackFromEnd(true);
        messages_adapter.setLayoutManager(linearLayoutManager);
        messages_adapter.setAdapter(adapter);
