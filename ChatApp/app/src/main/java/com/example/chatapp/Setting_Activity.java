                                    ...
                                    reference.setValue(users).addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if(task.isSuccessful())
                                            {
                                                ...
                                                Toast.makeText(Setting_Activity.this, "Data Successfully Updated", Toast.LENGTH_SHORT).show();
                                                startActivity(new Intent(Setting_Activity.this,Home_Activity.class));
                                            }
                                            else {
                                                progressDialog.dismiss();

                                                Toast.makeText(Setting_Activity.this, "Something Went Wrong", Toast.LENGTH_SHORT).show();
                                            }
                                        }
                                    });
                                }
